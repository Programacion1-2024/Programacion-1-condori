...
namespace CLogica.Implementations
{
    public class PersonaLogic : IPersonaLogic
    {
        ...
        public void ActualizarPersona(Persona personaActualizar)
        {
            ...
            Persona? persona = _personaRepository.FindByCondition(p => p.Autor == personaActualizar.Autor).FirstOrDefault();
            ...
            persona.Nacionalidad = personaActualizar.Nacionalidad;
