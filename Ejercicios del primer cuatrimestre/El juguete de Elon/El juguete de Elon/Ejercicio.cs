namespace El_juguete_de_Elon
{
    ...
    class RemoteControlCar
    {
        ...
        {
            throw new NotImplementedException("Por favor implementa el método (static) RemoteControlCar.Comprar()");
        }

        public string MostrarDistancia()
        {
            throw new NotImplementedException("Por favor implementa el método RemoteControlCar.MostrarDistancia()");
        }

        public string MostrarBateria()
        {
            throw new NotImplementedException("Por favor implementa el método RemoteControlCar.MostrarBateria()");
        }

        public void Conducir()
        {
            throw new NotImplementedException("Por favor implementa el método RemoteControlCar.Conducir()");
        }
    }
